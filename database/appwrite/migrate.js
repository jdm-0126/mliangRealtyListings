...
async function run() {
  ...
  await attr('string',   COLLECTIONS.LISTINGS, 'Title',          { size: 255 })
  await attr('string',   COLLECTIONS.LISTINGS, 'Financing_options', { size: 255 })
  await attr('string',   COLLECTIONS.LISTINGS, 'CGT',            { size: 100 })
  await attr('string',   COLLECTIONS.LISTINGS, 'Transfer_Title', { size: 100 })
  await attr('string',   COLLECTIONS.LISTINGS, 'Description',    { size: 5000 })
  ...
  await attr('string',   COLLECTIONS.LISTINGS, 'FB_Link',        { size: 2000 })
