...
import { TABLES } from "@/lib/shared/constants"
...
//   }
  ...
  const { hasPhotos, hasVideo } = useMemo(() => {
    ...
    //   hasVideo: !!([property.photos?.[0] || property.video_url || property.facebook_video_url] || property.tiktok_video_url),
    }
  }, [property])
  ...
  const copyMortgageComputation = () => {
    ...
    const displayPropertyId = property.property_id > 2 ? property.property_id - 1 : property.property_id + 1
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-green-600">{property.listing_price}</p>
