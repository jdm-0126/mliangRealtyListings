...
export default function AdminLoginPage() {
  ...
  // If already authenticated via Appwrite session, redirect to admin
  useEffect(() => {
    account.get()
          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-lg transition-colors"
              >
                {loading ? (
                  <>
            ...
            <p className="mt-6 text-center text-xs text-gray-500">
              Not an admin?{' '}
              <a href="/" className="text-blue-600 hover:underline font-medium">Back to website</a>
            </p>
          </div>
        </div>
      </div>
