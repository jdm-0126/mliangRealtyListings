...
- [x] 2. Create SEO utilities and JSON-LD helpers
  - [x] 2.1 Create JSON-LD builder functions
  ...
  - [x] 2.2 Create canonical URL builder utility
  ...
  - [x] 2.3 Write property tests for SEO utilities (Properties 10, 16, 17)
...
- [x] 3. Restructure root layout and create route group scaffolding
  - [x] 3.1 Strip admin components from root layout
  ...
  - [x] 3.2 Create the `(public)` route group directory structure
  ...
  - [x] 3.3 Create the `(admin)` route group directory structure and move existing pages
...
- [x] 4. Implement AuthGuard and Admin Layout
  - [x] 4.1 Create the AuthGuard client component
  ...
  - [x] 4.3 Write property test for AuthGuard (Property 1)
  ...
  - [x] 4.4 Update Settings page logout to redirect to `/`
...
- [x] 6. Build Public Layout components
  - [x] 6.1 Create the SocialLinks server component
  ...
  - [x] 6.2 Write property test for SocialLinks rendering (Property 5)
  ...
  - [x] 6.3 Create the PublicHeader client component
  ...
  - [x] 6.4 Create the PublicFooter server component
  ...
  - [x] 6.5 Create the Public Layout
  ...
  - [x] 6.6 Write property test for public pages containing no admin components (Property 18)
...
- [x] 7. Build the JsonLd component and create the `og-image.jpg` static asset
  - [x] 7.1 Create the JsonLd server component
    - Create `app/(public)/components/JsonLd.tsx` that renders `<script type="application/ld+json" dangerouslySetInnerHTML=...>`
    - _Requirements: 7.4, 4.5_

  - [x] 7.2 Add a static OG image placeholder
...
- [x] 8. Implement the Public Homepage (`/`)
  ...
  - [x] 8.2 Add Featured Listings section to homepage
    - In `app/(public)/page.tsx`, call Supabase with `.ilike('status', 'active').order('property.priced', { ascending: false }).limit(6)`
  ...
  - [x] 8.4 Add Services section to homepage
    - Render three service content blocks (property sales, rental properties, lot sales) each with heading and paragraph
    - _Requirements: 2.5_

  - [x] 8.5 Add social media icons row to homepage
    - Embed `<SocialLinks>` component in the homepage
    - _Requirements: 2.6_

- [x] 9. Build shared public listing components
  - [x] 9.1 Create the ListingCard server component
  ...
  - [x] 9.2 Write property test for ListingCard required fields (Property 7)
  ...
  - [x] 9.3 Create the ImageGallery client component
...
- [x] 10. Implement the Public Listings Page (`/listings`)
  - [x] 10.1 Create the ListingsClientWrapper client component
  ...
  - [x] 10.2 Write property test for filter intersection correctness (Property 6)
  ...
  - [x] 10.5 Create the Listings page server component
...
- [x] 11. Implement the Property Detail Page (`/listings/[id]`)
  - [x] 11.1 Create the Property Detail page server component
    ...
    - Query Supabase by `property.priced`; render "Property not found" + link to `/listings` on null result
...
- [x] 13. Implement the Contact Page and InquiryForm (`/contact`)
  ...
  - [x] 13.2 Write property test for contact number validation (Property 12)
  ...
  - [x] 13.3 Create the InquiryForm client component
  ...
  - [x] 13.4 Write property test: invalid form never calls Supabase (Property 13)
  ...
  - [x] 13.5 Write property test: valid form inserts correct data (Property 14)
